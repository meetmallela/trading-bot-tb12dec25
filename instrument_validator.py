...
HOW TO INTEGRATE (order_placer_db_production.py):
    ...
    2. Initialize after loading config (once at startup):
         validator = InstrumentValidator(logger=logging)  # uses MasterConfiguration/data/valid_instruments.csv
...
class InstrumentValidator:
    ...
    def __init__(self, csv_path: str = None,
                 logger=None):
        self.csv_path = csv_path or get_instruments_path()

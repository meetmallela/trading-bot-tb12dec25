            ...
            for attempt in range(max_retries):
                try:
                    ...
                    if exchange == 'MCX':
                        ...
                        if action.upper() == 'BUY':
                            limit_price = signal_data.get('entry_price', 0) * 1.05  # 5% above entry
                        else:
                            limit_price = signal_data.get('entry_price', 0) * 0.95  # 5% below entry
                        ...
                        logging.info(f"[MCX LIMIT] Order placed with limit price: {limit_price}")
                    else:
        ...
        for sig in signals:
            try:
                ...
                if instrument_type == 'FUTURES':
                    ...
                    order_result = self.place_futures_order(data)
                        ...
                        try:
                            ...
                            if exchange == 'MCX':
                                ...
                                if data['action'].upper() == 'BUY':
                                    limit_price = data.get('entry_price', 0) * 1.05  # 5% above entry
                                else:
                                    limit_price = data.get('entry_price', 0) * 0.95  # 5% below entry

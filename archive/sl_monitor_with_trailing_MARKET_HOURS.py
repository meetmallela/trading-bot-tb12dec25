...
def is_market_open():
    ...
    Returns True only during active trading hours
    """
    try:
        ...
        # If timezone fails, assume market is open (safe default)
        return True
...
class EnhancedSLMonitor:
    ...
    def monitor_open_positions(self):
        ...
        # CHECK MARKET HOURS FIRST - Skip if market is closed
        if not is_market_open():
            ...
            logging.info(f"[INFO] SL monitoring will auto-resume at 9:15 AM next trading day")
            return  # Exit early - don't check positions or place orders
            ...
            for pos in open_positions:
                ...
                if existing_sl:
                    ...
                    if sl_type == "TRAILING" and new_sl > current_sl_trigger:
                        ...
                        if sl_type == "HOLD":
                            # Calculate correct threshold for logging (105% of entry price)

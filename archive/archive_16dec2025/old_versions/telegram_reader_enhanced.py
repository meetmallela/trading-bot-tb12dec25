"""
telegram_reader_enhanced.py - Read signals from Telegram channels with comprehensive logging
...
class TelegramSignalReader:
    ...
    async def process_message(self, event):
        ...
        # Try to parse signal
        parsed_signal = self.parser.parse_signal(message_text)
...
async def main():
    ...
    try:
        ...
        logger.info("\n" + "="*60)
        logger.info("ENHANCED TELEGRAM SIGNAL READER STARTED")
        logger.info("="*60)
